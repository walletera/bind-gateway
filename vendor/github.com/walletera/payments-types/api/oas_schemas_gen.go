...
type Payment struct {
	...
	// Id assigned to the operation by the payment scheme.
...
func (s *Payment) GetStatusReason() OptString {
...
func (s *Payment) SetStatusReason(val OptString) {
	s.StatusReason = val
}
...
// GetSchemeId returns the value of SchemeId.
func (s *PaymentUpdate) GetSchemeId() OptString {
	return s.SchemeId
}
...
// GetStatusReason returns the value of StatusReason.
func (s *PaymentUpdate) GetStatusReason() OptString {
	return s.StatusReason
}
...
// SetSchemeId sets the value of SchemeId.
func (s *PaymentUpdate) SetSchemeId(val OptString) {
	s.SchemeId = val
}
...
// SetStatusReason sets the value of StatusReason.
func (s *PaymentUpdate) SetStatusReason(val OptString) {
	s.StatusReason = val
}
